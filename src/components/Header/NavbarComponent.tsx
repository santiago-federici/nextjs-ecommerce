  ...
  return(
    ...
    <>
      ...
      <div className='lg:hidden'>        
        <Sheet>
          <SheetTrigger className={`${pathname === '/' ? 'text-white' : 'text-black'} lg:hidden cursor-pointer hover:scale-105 hover:opacity-70 transition duration-200 max-lg:order-1`}>
            <Menu />
          </SheetTrigger>
