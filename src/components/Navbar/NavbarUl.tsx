...
export function NavbarUl ({ isMenuOpen, session }: { isMenuOpen: boolean, session: any }) {
  return (
    <ul className={`${isMenuOpen ? 'block' : 'hidden'} grid lg:flex gap-4 py-4 px-6 lg:px-0 lg:py-0 bg-surface z-50 lg:z-auto lg:bg-transparent absolute lg:relative top-16 lg:top-0 w-[101%] left-[-1px] lg:w-auto`}>
