...
export function YoutubeLogo ({ strokeColor = 'currentColor' }: { strokeColor?: string }) {
  return (
    <svg 
      viewBox="0 0 24 24" 
      width="30" 
